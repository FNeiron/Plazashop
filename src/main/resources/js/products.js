  ...
  let displayProduct = items.map(
    (product) => ` 
                ...
                <div class="card d-flex">
                  ...
                  <h4>${product.title}</h4>
                  <div class="price">
                    <span>Цена</span><span class="color">₽${product.price}</span>
                  </div>
                  <a class="zakaz" id="zakaz">
                    <div class="button btn">Добавить в корзину+</div>
                  </a>
                </div>
              </div>
                  `
...
const numInForm = document.querySelector("#zakazat");
